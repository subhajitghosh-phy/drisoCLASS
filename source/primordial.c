      ...
      for (index_ic2 = index_ic1+1; index_ic2 < ppm->ic_size[index_md]; index_ic2++) {
        ...
        if (_scalars_) {
          ...
          if ((ppt->has_ad == _TRUE_) && (ppt->has_drid == _TRUE_) &&
            ...
            one_correlation = ppm->c_ad_drid;
            one_tilt = ppm->n_ad_drid;
          ...
          if ((ppt->has_cdi == _TRUE_) && (ppt->has_drid == _TRUE_) &&
            ...
            one_correlation = ppm->c_cdi_drid;
          ...
          if ((ppt->has_drid == _TRUE_) && (ppt->has_niv == _TRUE_) &&
            ...
            one_correlation = ppm->c_drid_niv;
            one_tilt = ppm->n_drid_niv;
          ...
          if ((ppt->has_drid == _TRUE_) && (ppt->has_nid == _TRUE_) &&
              (((index_ic1 == ppt->index_ic_drid) && (index_ic2 == ppt->index_ic_nid)) ||
               ((index_ic2 == ppt->index_ic_drid) && (index_ic1 == ppt->index_ic_nid)))) {
            one_correlation = ppm->c_drid_nid;
