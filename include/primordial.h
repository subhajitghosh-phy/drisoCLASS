...
struct primordial {
  ...
  double f_drid;  /**< dark radiation density isocurvature (DRID) entropy-to-curvature ratio \f$ S_{drid}/R \f$*/
  double n_drid;  /**< DRID tilt */
  double alpha_drid; /**< DRID running */
  ...
  double c_ad_drid; /**< ADxDRID cross-correlation at pivot scale, from -1 to 1 */
  double n_ad_drid; /**< ADxDRID cross-correlation tilt */
  double alpha_ad_drid; /**< ADxDRID cross-correlation running */
  ...
  double c_bi_drid; /**< BIxDRID cross-correlation at pivot scale, from -1 to 1 */
  double n_bi_drid; /**< BIxDRID cross-correlation tilt */
  double alpha_bi_drid; /**< BIxDRID cross-correlation running */
  ...
  double c_cdi_drid; /**< CDIxDRID cross-correlation at pivot scale, from -1 to 1 */
  double n_cdi_drid; /**< CDIxDRID cross-correlation tilt */
  double alpha_cdi_drid; /**< CDIxDRID cross-correlation running */
  ...
  double c_drid_niv; /**< NIDxNIV cross-correlation at pivot scale, from -1 to 1 */
  double n_drid_niv; /**< NIDxNIV cross-correlation tilt */
  double alpha_drid_niv; /**< NIDxNIV cross-correlation running */

  //SG..

  //SG.

  double c_drid_nid; /**< DRIDxNID cross-correlation at pivot scale, from -1 to 1 */
  double n_drid_nid; /**< DRIDxNID cross-correlation tilt */
  double alpha_drid_nid; /**< DRIDxNID cross-correlation running */
