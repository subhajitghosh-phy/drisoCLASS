...
enum dr_coupling_nature {decoup,recoup};//SG - Nature of DR interaction -- Decoupling/Recoupling
...
struct background
{
  ...
  double * T_ncdm,T_ncdm_default;       /**< list of 1st parameters in
					     ...
					     default value */
  double T_ncdm_all; //SG//
  double Geff; //SG - interaction parameter for DR (decoupling)
  enum dr_coupling_nature dr_coupling;
